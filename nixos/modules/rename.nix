...

{
  imports = [
    ...
    (mkRemovedOptionModule [ "services" "kubernetes" "apiserver" "insecurePort" ] "insecurePort has been removed from kubernetes apiserver")
    (mkRemovedOptionModule [ "services" "kubernetes" "apiserver" "publicAddress" ] "publicAddress option has been removed from kubernetes apiserver")
    (mkRenamedOptionModule [ "services" "kubernetes" "addons" "dashboard" "enableRBAC" ] [ "services" "kubernetes" "addons" "dashboard" "rbac" "enable" ])
    (mkRemovedOptionModule [ "services" "kubernetes" "controllermanager" "address" ] "address option has been removed from kubernetes controller-manager")
    (mkRemovedOptionModule [ "services" "kubernetes" "controllermanager" "port" ] "port option has been removed from kubernetes controller-manager")
    (mkRemovedOptionModule [ "services" "kubernetes" "scheduler" "address" ] "address option has been removed from kubernetes scheduler")
    (mkRemovedOptionModule [ "services" "kubernetes" "scheduler" "port" ] "port option has been removed from kubernetes scheduler")
    ...
    (mkRenamedOptionModule [ "services" "kubernetes" "kubelet" "healthz" "bind" ] ["services" "kubernetes" "kubelet" "healthz" "bindAddress"])
